...
<!-- xmlspec.xsl: An HTML XSL[1] Stylesheet for XML Spec V2.1[2] markup
     ...
     Version: $Id: xmlspec.xsl,v 1.8 2014/03/12 15:53:59 jbarnett2 Exp $
     ...
     Date:    Created 07 September 1999
              Last updated $Date: 2014/03/12 15:53:59 $ by $Author: jbarnett2 $
...
<!-- ====================================================================== -->
  ...
  <xsl:template match="constraintnote/head">
    <p xmlns="http://www.w3.org/1999/xhtml" class="prefix">
      ...
      <em><xsl:text>Constraint: </xsl:text><xsl:apply-templates/></em>
    </p>
  </xsl:template>
  ...
  <xsl:template match="vcnote/head">
    <p xmlns="http://www.w3.org/1999/xhtml" class="prefix">
      ...
      <em><xsl:text>Validity constraint: </xsl:text><xsl:apply-templates/></em>
    </p>
  </xsl:template>
  ...
  <xsl:template match="wfcnote/head">
    <p xmlns="http://www.w3.org/1999/xhtml" class="prefix">
      ...
      <em><xsl:text>Well-formedness constraint: </xsl:text><xsl:apply-templates/></em>
    </p>
  </xsl:template>
